...
def merge_outputs(results, split_files, original_pdf_path):
    ...
    TEMP_DIR = os.path.join("01_parse", "upstage_document_parse", "temp")
...
#     # 예시:
#     # results = [
#     #    ({"html": "01_parse/upstage_document_parse/temp/[DP]_20241220_..._1~50.html"}, []),
#     #    ({"html": "01_parse/upstage_document_parse/temp/[DP]_20241220_..._51~100.html"}, [])
#     # ]
