...
| VR을 이용한 EMDR의 양측성 안구운동이 우울증 감소에 미치는 영향에 관한 연
<<SPLIT>>
g-Ho Suh) |  |
![id_2](./Items/2_page_1_table_1.png)
...
한 G대학교 학생들을 대상으로 우울 척도(CES-D)를 사용하여 우울증 
<<SPLIT>>
실(VR)을 이용한 새로운 접근법의 잠재력을 탐구하기 위해 수행되었다. 이를 검정하기 위해, 경기도에 위치
...
Abstract
This study was conducted to explore the potenti
<<SPLIT>>
 확인하였다.
■ 중심어 : VR ; EMDR ; EEG ; 우울증 ; 베타파
Abstract
...
showed that EMDR therapy using a VR HMD (M=4.67) had 
<<SPLIT>>
aired sample t-tests with SPSS 27. The results
...
다. EEG(뇌파 검사)를 통해 EMDR 치료
<<SPLIT>>
 치료하는 데 효과적인 치료법으로 잘 알려
져 있지만, 최근에는 이와 관련된 뇌파 변화를
측정하고자 하는 연구들도 활발히 진행되고 있
