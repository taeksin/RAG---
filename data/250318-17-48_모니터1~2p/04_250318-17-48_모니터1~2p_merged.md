...
```
| VR을 이용한 EMDR의 양측성 안구운동이 우울증 감소에 미치는 영향에 
<<SPLIT>>
g-Ho Suh) |  |
![id_2](./Items/2_page_1_table_1.png)
...
Studies Depression Scale (CES-D). Sixteen participants with CES-D scores of 25 or
<<SPLIT>>
 for Epidemiologic
...
showed that EMDR therapy using a VR HMD (
<<SPLIT>>
yzed using paired sample t-tests with SPSS 27. The results
