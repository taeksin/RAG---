...
def merge_outputs(results, split_files, original_pdf_path):
    ...
    TEMP_DIR = os.path.join("upstage_document_parse", "temp")
...
#     # 예시:
#     # results = [
#     #    ({"html": "upstage_document_parse/temp/[DP]_20241220_..._1~50.html"}, []),
#     #    ({"html": "upstage_document_parse/temp/[DP]_20241220_..._51~100.html"}, [])
#     # ]
