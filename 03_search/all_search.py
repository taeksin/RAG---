...
db_options = {
    "DB 1": {
        "path": "vdb/faiss_index/small/1_N_split",
        "description": "N글자로 그냥 나눔"
    },
    "DB 2": {
        "path": "vdb/faiss_index/small/2_N_split+all",
        "description": "N글자로 그냥 나눔 + 표같은 붙을건 붙음"
    },
    "DB 3": {
        "path": "vdb/faiss_index/small/3_upstage_layout",
            ...
            try:
                ...
                for doc, faiss_score in docs_with_score:
                    ...
                    rows.append({
                        ...
                        # "faiss_score": faiss_score,  # 필요 시 주석 해제
                    })
