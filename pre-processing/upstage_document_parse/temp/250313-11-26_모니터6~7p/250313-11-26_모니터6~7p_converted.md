...
이미지는 3D 스펙트럼을 보여주는 표입니다. 각 행은 번호로 구분되어 있으며, 두 개의 열로 나뉘어 있습니다. 각 열은 "EMDR-Monitor"와 "EMDR-HMD(VR)"로 레이블이 붙어 있습니다. 각 셀에는 스펙트럼 이미지가 포함되어 있으며, 빨간색 점선으로 구분된 부분이 있습니다.
