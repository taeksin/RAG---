...
json_output_path = os.path.join("01_pre_processing/llamaParse/output", f"{time_prefix}_{base_name}_parsed.json")
...
output_dir = "01_pre_processing/llamaParse/output"
