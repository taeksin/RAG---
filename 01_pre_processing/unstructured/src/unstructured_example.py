...
def process_pdf_to_markdown(pdf_path, languages=["kor", "eng"]):
    ...
    json_folder = "01_pre_processing/unstructured/converted_documents"
    ...
    images_folder = os.path.join("01_pre_processing/unstructured/output_images", base_filename)
    ...
    output_folder = "01_pre_processing/unstructured/converted_documents"
